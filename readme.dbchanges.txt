...
//Action_Code populating
ALTER TABLE action_code ALTER COLUMN code TYPE VARCHAR(50);


INSERT INTO Action_Code (code) VALUES
('Complaint Registered'),
('Assigned to Level 2'),
('ATR Report Generated by Level 2'),
('ATR Verified by Level 1'),
('ATR Rejected by Level 1'),
('ATR Updated & Resubmitted by Level 2'),
('Complaint Disposed');
